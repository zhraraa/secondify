...
<div class="card">
    ...
    <div class="left-area">
        ...
        <img src="<?= SECONDIFY; ?>/assets/images/logo/logo3.png" alt="Logo">
    ...
    <div class="right-area">
        ...
        <div class="header-login">
            ...
            <p>
                Daftar sekarang dan mulai berjualan atau
                berbelanja di Secondify
            </p>
        </div>
        ...
        <form action="<?= SECONDIFY; ?>/apps/controllers/auth/register.php" method="POST">
            ...
            <div class="input-group">
                ...
                <div>
                    ...
                    <select
                        name="lokasi"
                        class="input-form dropdown-lokasi"
                        style="padding-left:32px;"
                        required>

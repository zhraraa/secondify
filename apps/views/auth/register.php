            ...
            <div class="right-area">
                ...
                <form action="<?= SECONDIFY; ?>/apps/controllers/auth/register.php" method="POST">
                    <div class="input-group">
                        ...
                        <div>
                            <i data-lucide="user" style="width: 14px; color:rgba(0, 0, 0, 0.7); position: absolute; margin-left: 8px; align-self: center;"></i>
                            <input type="text" id="name" name="nama" class="input-form" placeholder="Masukkan Nama Lengkap" style="padding-left: 30px;" required>
                        </div>
                    </div>
                    ...
                    <div class="input-group">
                        ...
                        <div>
                            <i data-lucide="at-sign" style="width: 14px; color:rgba(0, 0, 0, 0.7); position: absolute; margin-left: 8px; align-self: center;"></i>
                            <input type="text" name="username" class="input-form" placeholder="username" style="padding-left: 30px;" required>
                        </div>
                    </div>
                    ...
                    <div class="input-group">
                        ...
                        <div>
                            ...
                            <input type="email" id="email" name="email" class="input-form" placeholder="nama@gmail.com" style="padding-left: 30px;" required>
                        </div>
                    </div>
                    ...
                    <div class="input-group">
                        ...
                        <div style="display: flex; flex-direction: row; align-items: center;">
                            ...
                            <input type="password" id="password" name="password" class="input-form" placeholder="Masukkan Password" style="padding-left: 30px;" required>
                        </div>
                    </div>
                    ...
                    <div class="input-group">
                        ...
                        <div style="display: flex; flex-direction: row; align-items: center;">
                            <i data-lucide="lock" style="width: 14px; color:rgba(0, 0, 0, 0.7); position: absolute; margin-left: 8px; align-self: center;"></i>
                            <input type="password" id="confirm" name="confirm" class="input-form" placeholder="Masukkan Konfirmasi Password" style="padding-left: 30px;" required>
                        </div>
                    </div>
                    ...
                    <div class="input-group">
                        <label>Lokasi</label>
                        <div>
                            <i data-lucide="map-pin" style="width: 14px; color:rgba(0, 0, 0, 0.7); position: absolute; margin-left: 8px; align-self: center;"></i>
                            <select name="lokasi" id="lokasi" class="input-form dropdown-lokasi" style="padding-left: 30px;" required>
